...
from urllib.parse import quote  # <-- This is the missing tool that fixes the error safely!
...
# 5. Request the image from Pollinations.ai with fixed base domain and custom parameters
seed_num = random.randint(1, 99999)
url = f"https://image.pollinations.ai/p/{encoded_prompt}?width=1024&height=1024&enhance=true&seed={seed_num}"

print(f"Requesting URL: {url}")
response = requests.get(url)

# 6. Create the folder and save the image with today's date
